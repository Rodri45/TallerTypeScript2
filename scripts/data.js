...
export var data = [
    ...
    new Serie(4, "The Big Bang Theory", "CBS", 12, "Leonard and Sheldon are brilliant physicists—geniuses in the laboratory but socially challenged everywhere else. Enter beautiful, street-smart neighbor Penny...", "https://www.cbs.com/shows/big_bang_theory/about/", "./images/thebigbangtheory.jpeg"),
    ...
    new Serie(6, "A Very English Scandal", "BBC", 2, "A Very English Scandal is a fact-based three-part British television comedy-drama miniseries based on John Preston's book...", "https://www.bbc.co.uk/programmes/p065smy4", "./images/averyenglishscandal.jpeg")
];
